const categories = {
  movies: [
    { name: "The Shawshank Redemption", hint: "Morgan Freeman movie" },
    { name: "The Godfather", hint: "Italian mafia" },
    { name: "The Dark Knight", hint: "Christian Bale plays a bat" },
    { name: "The Lord of the Rings", hint: "Based on Tolkien" },
    { name: "Pulp Fiction", hint: "A Tarantino movie" },
    { name: "Star Wars", hint: "Laser sword" },
    { name: "Inception", hint: "Dreams" },
    { name: "Forrest Gump", hint: "Life is like a box of chocolates" },
    { name: "Fight Club", hint: "there are only two rules" },
    { name: "The Matrix", hint: "Human battery" },
    {
      name: "One Flew Over the Cuckoo's Nest",
      hint: "1963 Jack Nicholson movie",
    },
    { name: "The Silence of the Lambs", hint: "FBI and canibal killers" },
    { name: "Interstellar", hint: "Wormholes and Blackholes" },
    { name: "Saving Private Ryan", hint: "WW2 movie in Normandy" },
    { name: "The Green Mile", hint: "Steven King novel" },
    { name: "Back to the Future", hint: "Goint on adventures in a Delorean" },
    { name: "Spirited Away", hint: "No-face" },
    {
      name: "The Lion King",
      hint: "Uncle murders father in front of his own son",
    },
    { name: "The Usual Suspects", hint: "Keyser Soze" },
    { name: "Whiplash", hint: "drums" },
  ],
  shows: [
    { name: "Game of Thrones", hint: "Good until season 5" },
    { name: "House of the Dragon", hint: "The prequel with even more incest" },
    { name: "House of Cards", hint: "Kevin Spacey is president" },
    { name: "The Simpsons", hint: "The longest running show" },
    { name: "South Park", hint: "They kill Kenny" },
    { name: "Friends", hint: "More than acquaintances" },
    { name: "How I Met Your Mother", hint: "HIMYM" },
    { name: "Daredevil", hint: "Blind batman" },
    { name: "Stranger Things", hint: "Kids play DnD for real" },
    { name: "The Crown", hint: "The queen" },
    {
      name: "Game of Thrones",
      hint: "Fantasy drama about noble families fighting for the Iron Throne",
    },
    {
      name: "The Sopranos",
      hint: "Crime drama about a New Jersey mobster seeking therapy",
    },
    {
      name: "The Simpsons",
      hint: "Animated sitcom about a family living in Springfield",
    },
    {
      name: "The Walking Dead",
      hint: "Post-apocalyptic horror drama about a group of survivors fighting zombies",
    },
    {
      name: "The Big Bang Theory",
      hint: "Sitcom about a group of nerdy friends and their neighbor",
    },
    {
      name: "Breaking Bad",
      hint: "Drama about a high school chemistry teacher who turns to cooking and selling meth after being diagnosed with cancer",
    },
    {
      name: "Friends",
      hint: "Sitcom about a group of friends living in New York City",
    },
    {
      name: "Seinfeld",
      hint: "Sitcom about a stand-up comedian and his experiences in New York City",
    },
    {
      name: "The X-Files",
      hint: "Sci-fi drama about two FBI agents investigating paranormal cases",
    },
    { name: "The Crown", hint: "Drama about the reign of Queen Elizabeth II" },
    {
      name: "The Office",
      hint: "Mockumentary sitcom about the daily lives of office workers",
    },
    {
      name: "The West Wing",
  ...
  games: [
    { name: "League of Legends", hint: "Spreading toxicity since 2009" },
    {
      name: "Animal Crossing New Horizons",
      hint: "Going in debt to pay off a raccoon",
    },
    { name: "Mortal Kombat", hint: "Finish him" },
    { name: "Valorant", hint: "Giving riot even more money" },
    {
      name: "Counter Strike Global Offensive",
      hint: "Lobby filled with russians",
    },
    { name: "Dark Souls", hint: "This is a hard one" },
    { name: "Elden Ring", hint: "Sequel to the hardest game" },
    { name: "Batman: Arkham City", hint: "Bat and a man game" },
    { name: "Tomb Raider", hint: "Lara does some raids" },
    {
      name: "Minecraft",
  ...
  cities: [
    { name: "New York", hint: "Big Apple" },
    { name: "Skopje", hint: "Capital of Macedonia" },
    { name: "Paris", hint: "City of love" },
    { name: "Berlin", hint: "A city united in 1989 after the cold war" },
    { name: "Los Angeles", hint: "Hollywood" },
    { name: "Bitola", hint: "the Manaki brothers" },
    { name: "Ohrid", hint: "Shares a name with one of the oldest lakes" },
    { name: "Tokyo", hint: "Cat cafes" },
    { name: "Seoul", hint: "K-pop" },
    { name: "London", hint: "Constant rain" },
    { name: "Belgrade", hint: "Capital of Serbia" },
    { name: "Sarajevo", hint: "Capital of Bosnia" },
    { name: "Frankfurt", hint: "On the river Main" },
    { name: "Bern", hint: "Capital city of Switzerland" },
    { name: "Zurich", hint: "Global center for banking" },
    { name: "Sidney", hint: "Down under" },
    { name: "Las Vegas", hint: "Casino central" },
    { name: "San Diego", hint: "Like and near LA but better" },
    { name: "Anchorage", hint: "Waaay up north" },
    { name: "Istanbul", hint: "Bridge between Europe and Asia" },
    { name: "Osaka", hint: "Dotonbori street" },
    { name: "Kumanovo", hint: "Sashko Kocev" },
    { name: "Huston", hint: "____ we have a problem" },
  ],
  music: [
    {
      name: "The Beatles",
...
function checkForLetter(letter) {
  ...
  if (field === secretWord.name.toUpperCase()) {
    ...
    document.querySelector(".word-field").classList.remove('blank');
    secretWord = {};
  }
}
